/**
 * ============================================================================
 * LEGACY / DEPRECATED — NOT USED BY MYRAA AI CURRENT SYSTEM
 * ============================================================================
 * This standalone Node/Playwright server (formerly run on port 3001) has been
 * superseded by Myraa AI's integrated Python FastAPI desktop agent
 * (desktop_agent/ on port 8765), which natively provides all browser
 * automation tools (desktopBrowser* via Playwright) along with 50+ other
 * OS automation tools.
 *
 * Kept for historical reference only. Do NOT launch this in production.
 * ============================================================================
 *
 * Myraa Playwright Local Agent Server (Legacy)
